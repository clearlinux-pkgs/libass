...
Version  : 0.17.0
Release  : 6
URL      : https://github.com/libass/libass/archive/0.17.0/libass-0.17.0.tar.gz
Source0  : https://github.com/libass/libass/archive/0.17.0/libass-0.17.0.tar.gz
...
%prep
%setup -q -n libass-0.17.0
cd %{_builddir}/libass-0.17.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675296545
